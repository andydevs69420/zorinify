...
const Gettext = imports.gettext.domain('zorin-desktop-icons');
...
var FileItem = class {
    ...
    _createMenu() {
        ...
        case Enums.FileType.NONE:
            ...
            if (this._isValidDesktopFile && !this._desktopManager.writableByOthers && !this._writableByOthers && (this._selectedItemsNum == 1 ) && !this.trustedDesktopFile) {
                this._menu.add(new Gtk.SeparatorMenuItem());
                this._allowLaunchingMenuItem = new Gtk.MenuItem({label: _("Allow Launching")});
